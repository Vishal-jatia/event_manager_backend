...
function sendCheckInMail(data) {
    ...
    let mailOptions = {
        ...
        html: `Dear ${data.name},<br><br>
           ...
           Vishal Jatia: vjatia449@gmail.com<br>
...
const postEvent = async (req, res) => {
    console.log("Starting Post Event service");
    ...
    console.log("Post Event Service ended");
    
    res.status(200).send({ msg: "event created", event_id: token });
};

const allEvents = async (req, res) => {
    console.log("Get all event started");
    
    Event.find({})
        .then((data) => {
            console.log("Get all event ended");
...
const particularEvent = async (req, res) => {
    console.log("Get single event started");

    const eventId = req.body.event_id;
    Event.find({ event_id: eventId })
        .then((data) => {
            console.log("Get single event ended");
...
const deleteEvent = async (req, res) => {
    console.log("Delete event service started");
    ...
    console.log("Delete event ended");
    
    res.status(200).send({ msg: "success" });
};

const checkin = async (req, res) => {
    console.log("Checkin service started");
    ...
    console.log("Check in service ended");
