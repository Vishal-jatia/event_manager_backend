...
const signIn = async (req, res) => {
    ...
    User.find({ email: Email }, async function (err, docs) {
        if (docs.length !== 0) {
            ...
            console.log("Signin service ended");
...
const signUp = async (req, res) => {
    ...
    User.find({ email: Email }, async function (err, docs) {
        if (docs.length !== 0) {
            ...
            console.log("Signup service ended");
...
const verifyLogin = async (req, res) => {
    console.log("Signin verification service started");
        ...
        if (docs.length === 0) {
            ...
            if (Email === docs[0].email && validUser) {
                User.find({ email: Email }, async function (err, user) {
                    console.log(user);
                    console.log("Signin verification service ended");
...
const verifyOtp = async (req, res) => {
    console.log("Signup verification service started");
    ...
    OtpAuth.find({ email: Email }, async function (err, docs) {
        if (docs.length === 0) {
            ...
            if (Email === docs[0].email && validUser) {
                ...
                console.log("Signup verification service ended");
