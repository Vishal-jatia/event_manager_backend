...
const setAdmin = async (req, res) => {
    console.log("Set admin service started");
    ...
    console.log("Set admin service ended");
    res.status(200).send({ msg: "Credentials Added" });
};

const adminAuth = async (req, res) => {
    console.log("Auth admin service started");
    ...
    Admin.find({ email: Email }, async function (err, docs) {
        if (docs.length === 0) {
        console.log("Auth admin service ended");
